...
export const NavbarNewPanelComponent = ({currentPath}) => {
    return (
        <div className={"w-full  flex gap-2 mx-auto"}>
            ...
            <nav className="sticky top-4 px-5 z-40  shadow-gray-300 flex flex-row items-center w-9/12 me-auto md:me-0 ms-auto justify-between rounded-xl bg-red-500 p-2 backdrop-blur-xl">
