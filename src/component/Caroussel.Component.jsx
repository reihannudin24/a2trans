      ...
      <div className="relative">
        <div className="overflow-x-auto " ref={scrollRef}>
          <div className="flex gap-4 lg:gap-3 pb-4">
            ...
            {data.map((res, index) => {
              return (<img key={index} alt="Img" className="w-56 h-40 flex-shrink-0 object-cover radius-card-img hover:scale-105" src={`${process.env.REACT_APP_PANEL_WEBSITE}/${res?.image_path}`} />)
            })}
